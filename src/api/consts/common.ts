...
// 草稿版本
export const DRAFT_VERSION = "3.3.17";
export const DRAFT_MIN_VERSION = "3.0.2";
export const DRAFT_VERSION_OMNI = "3.3.17";
...
export const OMNI_BENEFIT_TYPE_YZ = "seedance_20_fast_720p_output";
export const OMNI_BENEFIT_TYPE_FAST_YZ = "seedance_20_fast_720p_output";
